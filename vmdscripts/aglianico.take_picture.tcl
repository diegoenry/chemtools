...
#     exec /afs/msrc.pnl.gov/files/home/dgomes/software64/vmd187/vmd/tachyon_LINUXAMD64 -aasamples 12 plot.dat -format TARGA -o $take_picture(frame).tga
      set filename [format "scene.%04d.tga" $take_picture(frame)]
      exec /afs/msrc.pnl.gov/files/home/dgomes/software64/vmd187/vmd/tachyon_LINUXAMD64 -aasamples 12 plot.dat -format TARGA -o $filename
       }
    }
