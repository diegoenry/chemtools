...
write(*,*) "Computing Dihedrals ONLY for surface atoms (failsafe silicon dioxide code)"
write(*,*) "Excluding SI-O-SI-O"
write(*,*) "Excluding SI-Ob-SI-Ob"
write(*,*) "Excluding SI-Os-SI-Os"
write(*,*) "Excluding Os-SI-Os-Hs"
allocate(dihedrals(nbonds*5))
do i = 1, nangles*3,3
write(*,"(i8,A,$)") i,"\r"
iatm1=angles(i)
iatm2=angles(i+1)
iatm3=angles(i+2)
dinner:    do j=1,nbonds*2,2
        if(bonds(j)==iatm3) then
            if(bonds(j+1)/=iatm2) then
                if(bonds(j+1)>iatm1) then
! write(*,*) iatm1,iatm2,iatm3,bonds(j+1)
if(ttype(iatm1)==14.and.ttype(iatm3)==14) cycle dinner !exclude SI-O-SI-O dihedral  !bugfix Wed Mar  3 17:04:49 BRT 2010
if(ttype(iatm2)==14.and.ttype(bonds(j+1))==14) cycle dinner !exclude O-SI-O-SI dihedral
if(ttype(iatm1)==801.and.ttype(iatm3)==801) cycle dinner !exclude  Os  SI  Os  Hs dihedral Wed Mar  3 18:12:11 BRT 2010
if(ttype(iatm2)==801.and.ttype(bonds(j+1))==801) cycle dinner !exclude  Os  SI  Os  Hs dihedral Wed Mar  3 18:12:11 BRT 2010
...
if(ttype(iatm1)==14.and.ttype(iatm3)==14) cycle dinner !exclude SI-O-SI-O dihedral  !bugfix Wed Mar  3 17:04:49 BRT 2010
if(ttype(iatm2)==14.and.ttype(bonds(j))==14) cycle dinner !exclude O-SI-O-SI dihedral
if(ttype(iatm1)==801.and.ttype(iatm3)==801) cycle dinner !exclude  Os  SI  Os  Hs dihedral Wed Mar  3 18:12:11 BRT 2010
if(ttype(iatm2)==801.and.ttype(bonds(j))==801) cycle dinner !exclude  Os  SI  Os  Hs dihedral Wed Mar  3 18:12:11 BRT 2010
